...
public class MainMenu : MonoBehaviour
{
    ...
    public void HostLobby()
    {
        ...
        //this is if using steam connect only for ppl on friends list, ofc can change it to public later
        if (useSteam)
        {
    ...
    {
        //if the lobby failed to create it will just bring it back to the landing page panel
